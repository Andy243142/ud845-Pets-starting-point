...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //拿到从catalog中传过来的URI，用来区分值要差入一个新的宠物还是打开一个宠物的信息
    ...
    private void deletePet() {
        ...
        if(mCurrentPetUri != null){
            SQLiteDatabase db = mDbHelper.getWritableDatabase();
            int deleteId = getContentResolver().delete(mCurrentPetUri,null,null);
            if(deleteId == 0){
            ...
            case R.id.action_save:
                ...
                if (mCurrentPetUri == null) {
                    ...
                    if(!mNameEditText.getText().toString().trim().isEmpty()){
                        ...
                        Toast.makeText(this,"Please add all imformation",Toast.LENGTH_SHORT).show();
                    }
